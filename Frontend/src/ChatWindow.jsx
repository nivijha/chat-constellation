  ...
  return (
    <main className="chat-window">
      ...
      <nav className="navbar">
        ...
        <div className="navbar-right">
          ...
          <div className="user-menu-wrap">
            ...
            >
              {user?.avatar ? (
                <img src={user.avatar} alt={user.displayName} className="avatar-btn" style={{ objectFit: 'cover' }} />
              ) : (
            ...
            {dropdownOpen && (
              <>
                ...
                <div className="dropdown">
                  ...
                  <div className="dropdown-item dropdown-item--danger" onClick={() => { onLogout(); setDropdownOpen(false); }}>
      ...
      <div className={`input-area ${viewMode !== "chat" ? "input-area--disabled" : ""}`}>
        ...
        <p className="input-disclaimer">{t.chat.disclaimer}</p>
      </div>
